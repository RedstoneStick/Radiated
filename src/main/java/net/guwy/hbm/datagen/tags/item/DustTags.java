...
public class DustTags {
    private static void addTags() {
        register("sulfur", NTMResourcesNParts.SULFUR.get());
    ...
    private static void register(TagKey<Item> tagKey, Item... item) {
        itemTags.put(List.of(tagKey, TagKey.create(Registries.ITEM, ResourceLocation.parse("c:dusts"))), item);
    }
    private static void register(String tagKey, Item... item) {
        register(TagKey.create(Registries.ITEM, ResourceLocation.parse("c:dusts/" + tagKey)), item);
    }
