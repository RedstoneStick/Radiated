...
public class RTGPelletItem extends Item implements RadiatedItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.radiated.rtg_pellet.1")
        ...
        pTooltipComponents.add(Component.translatable("tooltip.radiated.rtg_pellet.3")
                ...
                .withStyle(ChatFormatting.GRAY));
        pTooltipComponents.add(Component.translatable("tooltip.radiated.rtg_pellet.4")
