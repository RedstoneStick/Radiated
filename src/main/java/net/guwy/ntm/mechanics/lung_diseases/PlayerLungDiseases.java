...
public class PlayerLungDiseases {
    ...
    public void increaseBlackLung(int increase, Player player){
        ...
        // Message
        if(amount > 0) SFMessagesOnDisplay.addNewMessage(Component.translatable("message.ntm.coal_dust").getString());
    }
    ...
    public void increaseAsbestos(int increase, Player player){
        ...
        // Message
        if(amount > 0) SFMessagesOnDisplay.addNewMessage(Component.translatable("message.ntm.asbestos").getString());
    }
