...
import net.guwy.ntm.index.NTMTags;
...
public class GetRadiationVal {
    ...
    public static double getVal(ItemStack itemStack){
        ...
        else if (itemStack.is(NTMTags.Items.URANIUM_INGOT)) {return 0.35;}
        else if (itemStack.is(NTMTags.Items.URANIUM_NUGGET)) {return 0.035;}
        else if (itemStack.is(NTMTags.Items.URANIUM_RAW)) {return 0.02;}
        else if (itemStack.is(NTMTags.Items.URANIUM_PLATE)) {return 0.35;}
        else if (itemStack.is(NTMTags.Items.URANIUM_DUST)) {return 1.05;}
        else if (itemStack.is(NTMTags.Items.URANIUM_ORE)) {return 0.015;}
        else if (itemStack.is(NTMTags.Items.URANIUM_BLOCK)) {return 3.5;}
        else if (itemStack.is(NTMTags.Items.URANIUM_BLOCK_RAW)) {return 0.2;}

        else if (itemStack.is(NTMTags.Items.THORIUM_INGOT)) {return 0.1;}
        else if (itemStack.is(NTMTags.Items.THORIUM_NUGGET)) {return 0.01;}
        else if (itemStack.is(NTMTags.Items.THORIUM_RAW)) {return 0.006;}
        else if (itemStack.is(NTMTags.Items.THORIUM_PLATE)) {return 0.1;}
        else if (itemStack.is(NTMTags.Items.THORIUM_DUST)) {return 0.3;}
        else if (itemStack.is(NTMTags.Items.THORIUM_ORE)) {return 0.004;}
        else if (itemStack.is(NTMTags.Items.THORIUM_BLOCK)) {return 1.0;}
        else if (itemStack.is(NTMTags.Items.THORIUM_BLOCK_RAW)) {return 0.06;}
    ...
    public static void tooltipHandler(ItemTooltipEvent event){
        ...
        if(radiationVal != 0){
            ...
            event.getToolTip().add(Component.translatable("tooltip.ntm.radiation.radioactive").withStyle(ChatFormatting.GREEN));

            tooltip = Component.literal(
                            Double.toString(radiationVal)).append(Component.translatable("tooltip.ntm.radiation.rad_s").getString())
            ...
            if(count > 1){
                tooltip = Component.translatable("tooltip.ntm.radiation.stack")
                        .append(Double.toString(GetRadiationVal.getStackVal(itemStack)))
                        .append(Component.translatable("tooltip.ntm.radiation.rad_s").getString())
                        .withStyle(ChatFormatting.YELLOW);
                event.getToolTip().add(tooltip);
            }
        }
