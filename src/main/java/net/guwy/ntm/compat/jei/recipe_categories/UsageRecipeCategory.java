...
import net.guwy.ntm.index.NTMItems;
...
public class UsageRecipeCategory implements IRecipeCategory<UsageRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(NTM.MOD_ID, "usage");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(NTM.MOD_ID, "textures/jei/jei_use.png");
    ...
    public Component getTitle() {
        return Component.translatable("text.ntm.jei.usage");
    }
