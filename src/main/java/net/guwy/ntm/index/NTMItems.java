...
import net.guwy.ntm.content.items.*;
...
public class NTMItems {
    ...
    public static final RegistryObject<Item> YELLOWCAKE = ITEMS.register("yellowcake",
            () -> new BasicRadioactiveItem(new Item.Properties().tab(NTMCreativeModeTabs.RESOURCES_AND_PARTS).food(NTMFoods.YELLOWCAKE), 1.05){
                @Override
                public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
                    pTooltipComponents.add(Component.translatable("tooltip.ntm.yellowcake").withStyle(ChatFormatting.GOLD));
    ...
    public static final RegistryObject<Item> COFFEE = ITEMS.register("coffee",
            () -> new CoffeeItem(new Item.Properties().tab(NTMCreativeModeTabs.CONSUMABLES_AND_GEAR).food(NTMFoods.COFFE)));

    public static final RegistryObject<Item> COFFEE_RADIUM = ITEMS.register("coffee_radium",
            () -> new CoffeeItem(new Item.Properties().tab(NTMCreativeModeTabs.CONSUMABLES_AND_GEAR).food(NTMFoods.COFFE_RADIUM)){
                @Override
                public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
                    pTooltipComponents.add(Component.translatable("tooltip.ntm.radium_coffee").withStyle(ChatFormatting.GRAY));
                    super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
                }
            });
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block,
                                                                            CreativeModeTab tab){
        return NTMItems.BLOCK_ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().tab(tab)));
    }
