...
import net.guwy.ntm.content.network_packages.EnergySyncS2CPacket;
import net.guwy.ntm.content.network_packages.RTGSyncS2CPacket;
import net.guwy.ntm.content.network_packages.TurbineSyncS2CPacket;
...
public class NTMNetworking {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(NTM.MOD_ID, "messages"))
        ...
        net.messageBuilder(TurbineSyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
