package net.guwy.ntm.content.overlays;
...
public class HazmatHelmetOverlay {
    public static final ResourceLocation HELMET_OVERLAY_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/hazmat.png");
    public static final ResourceLocation DAMAGE_0_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/overlay_damage_0.png");
    public static final ResourceLocation DAMAGE_1_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/overlay_damage_1.png");
    public static final ResourceLocation DAMAGE_2_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/overlay_damage_2.png");
    public static final ResourceLocation DAMAGE_3_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/overlay_damage_3.png");
    public static final ResourceLocation DAMAGE_4_TEXTURE = new ResourceLocation(NTM.MOD_ID,
            "textures/overlay/armor/overlay_damage_4.png");
    public static final ResourceLocation DAMAGE_5_TEXTURE = new ResourceLocation(NTM.MOD_ID,
