...
import net.guwy.ntm.index.NTMTools;
...
public class GeigerCounterOverlay {
    public static final ResourceLocation OVERLAY_TEXTURE = new ResourceLocation(NTM.MOD_ID,
    ...
    private static String getRadSText(double geigerVal){
        ...
        text = text + " " + Component.translatable("tooltip.ntm.radiation.rad_s").getString();
